...
var _skill = __webpack_require__(2);

var _skill2 = _interopRequireDefault(_skill);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var board = new _nav2.default();
var skills = new _skill2.default();
  ...
  _createClass(Skill, [{
    ...
    value: function setup() {
      ...
      for (var i = 0; i < this.skills.length; i++) {
        this.skills[i].addEventListener("mouseover", function (e) {
          return _this.handleMouseOver(e);
        });
        this.skills[i].addEventListener("mouseout", function (e) {
